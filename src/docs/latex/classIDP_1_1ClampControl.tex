...
Check the bobbin badness \begin{DoxyReturn}{Returns}
...
Check the bobbin colour \begin{DoxyReturn}{Returns}
...
Pick up something using the clamp. \hypertarget{classIDP_1_1ClampControl_a31573846d9f7c61a6133b9dd465eca25}{
